...
<div id="joms-js--app-<?php echo $app->id; ?>" class="joms-module--stacked">
...
<div id="joms-js--app-<?php echo $app->id; ?>" class="joms-tab__content" <?php echo ($position == 'content') || ($i > 1) ? 'style="display:none"' : '' ;?>>
