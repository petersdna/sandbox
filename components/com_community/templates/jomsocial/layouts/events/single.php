                        ...
                        <div class="joms-stream__header no-gap">
                            <div class="joms-avatar--stream">
                                ...
                                <?php
                                    ...
                                    $year = date('y', $datestr);
                                ?>
                                <span class="month"><?php echo CEventHelper::formatStartDate($series, JText::_('M') ); ?></span>
                                <span class="date"><?php echo CEventHelper::formatStartDate($series, JText::_('d') ); ?></span>
                            ...
                            <div class="joms-popover__content">
                                ...
                                <?php echo CEventHelper::formatStartDate($series, $config->get('eventdateformat') ); ?></p>
