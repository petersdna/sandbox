...
//      if(type == 'text' || type == 'group' || type == 'textarea' || type =='date' )
    ...
    this.importUsers = function(){
        cWindowShow('jax.call("community","admin,users,importUsersForm");', 'Import users' , 450 ,400 );
    ...
    this.importGroups = function(){
        cWindowShow('jax.call("community","admin,groups,importGroupsForm");', 'Import groups' , 450 ,400 );
